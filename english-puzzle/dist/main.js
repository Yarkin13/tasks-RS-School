...
/***/ "./src/js/authorization-page.class.js":
/*!********************************************!*\
  !*** ./src/js/authorization-page.class.js ***!
  \********************************************/
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return AuthorizationPageModule; });
...
/* harmony import */ var _services_error_handler__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./services/error-handler */ "./src/js/services/error-handler.js");
...
var AuthorizationPageModule = /*#__PURE__*/function () {
  function AuthorizationPageModule(targetNode, node) {
    _classCallCheck(this, AuthorizationPageModule);

    this.targetNode = targetNode;
    this.node = node;
  }

  _createClass(AuthorizationPageModule, [{
    key: "renderAuthorizationPage",
    value: function renderAuthorizationPage() {
      this.targetNode.insertAdjacentHTML('afterbegin', this.node);
    }
  }, {
    key: "registration",
    value: function () {
      var _registration = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(registrationData) {
        var rawResponse, content, errors, hideNoticeBlock, noticeBlock;
            ...
            switch (_context.prev = _context.next) {
              ...
              case 6:
                ...
                if (content.hasOwnProperty('error')) {
                  errors = content.error.errors.map(function (el) {
                    return el.message;
                  });
                  Object(_services_error_handler__WEBPACK_IMPORTED_MODULE_6__["errorHandlerRegistrationInvalid"])(errors);
                } else {
                  hideNoticeBlock = function hideNoticeBlock() {
                  ...
                  noticeBlock = document.querySelector('.notice-block');
              ...
              case 10:
                ...
                Object(_services_error_handler__WEBPACK_IMPORTED_MODULE_6__["errorHandlerRegistrationExistEmail"])(_context.t0);
    ...
    key: "authorization",
    value: function () {
      var _authorization = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(loginData) {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 10:
                ...
                Object(_services_error_handler__WEBPACK_IMPORTED_MODULE_6__["errorHandlerLogInIncorrectEmailOfPassword"])();
    ...
    key: "renderStartBlock",
    value: function renderStartBlock() {
      var authorizationPage = document.querySelector('.authorization-page__wrapper');
...
/* harmony import */ var _nodes__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./nodes */ "./src/js/nodes.js");
/* harmony import */ var _authorization_page_class__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./authorization-page.class */ "./src/js/authorization-page.class.js");
/* harmony import */ var _main_page_class__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./main-page.class */ "./src/js/main-page.class.js");
...
function renderMainPage() {
  return _renderMainPage.apply(this, arguments);
}

function _renderMainPage() {
  _renderMainPage = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
    var authorizationPageNode, mainPage, mainPageWrapper, checkBtn, dntKnowBtn, translateBtn, audioBeginBtn, audioRepeatBtn;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            authorizationPageNode = document.querySelector('.authorization-page');
            authorizationPageNode.parentNode.removeChild(authorizationPageNode);
            mainPage = new _main_page_class__WEBPACK_IMPORTED_MODULE_6__["default"](_nodes__WEBPACK_IMPORTED_MODULE_4__["mainPageContentNode"], _nodes__WEBPACK_IMPORTED_MODULE_4__["mainPageResultBlockNode"]);
            mainPage.renderMainPageWrapper();
            mainPageWrapper = document.querySelector('.main-page');
            mainPage.renderMainPageHeader(mainPageWrapper, _nodes__WEBPACK_IMPORTED_MODULE_4__["mainPageHeaderNode"]);
            _context3.next = 8;
            return mainPage.renderMainPageContent(_nodes__WEBPACK_IMPORTED_MODULE_4__["mainPageContentNode"]);

          case 8:
            mainPage.renderMainPageButtonsBlock(mainPageWrapper, _nodes__WEBPACK_IMPORTED_MODULE_4__["mainPageButtonsBlockNode"]);
            mainPage.renderMainPageResultBlock(_nodes__WEBPACK_IMPORTED_MODULE_4__["mainPageResultBlockNode"]);
            mainPage.defineHintsState();
            checkBtn = document.querySelector('.main-page__buttons__check');
            dntKnowBtn = document.querySelector('.main-page__buttons__dnt-know');
            translateBtn = document.querySelector('.main-page__control-block__hints__translate');
            audioBeginBtn = document.querySelector('.main-page__control-block__hints__audio-begin');
            audioRepeatBtn = document.querySelector('.main-page__control-block__hints__audio-repeat');
            ...
            audioRepeatBtn.addEventListener('click', function () {
              mainPage.audioHint();
            });
...
var authorizationPageClass = new _authorization_page_class__WEBPACK_IMPORTED_MODULE_5__["default"](wrapper, _nodes__WEBPACK_IMPORTED_MODULE_4__["nodeAuthorizationPage"]);
authorizationPageClass.renderAuthorizationPage();
var registrationBtn = document.querySelector('.authorization-page__btns__registration');
var loginBtn = document.querySelector('.authorization-page__btns__log-in');
var inputLogin = document.querySelector('.authorization-page_authorization-form__login__input');
var inputPassword = document.querySelector('.authorization-page_authorization-form__password__input');
registrationBtn.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
...
loginBtn.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
  var startBtn, loginData, authorizationResult;
  return regeneratorRuntime.wrap(function _callee2$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          startBtn = document.querySelector('.start-block__btn');
          loginData = {};
          loginData.email = inputLogin.value;
          loginData.password = inputPassword.value;
          _context2.next = 6;
          return authorizationPageClass.authorization(loginData);

        case 6:
          authorizationResult = _context2.sent;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return MainPageClass; });
...
/* harmony import */ var _services_get_words_service__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./services/get-words.service */ "./src/js/services/get-words.service.js");
/* harmony import */ var _nodes__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./nodes */ "./src/js/nodes.js");
...
var MainPageClass = /*#__PURE__*/function () {
  function MainPageClass(mainPageContentNode, mainPageResultBlockNode) {
    _classCallCheck(this, MainPageClass);

    this.mainPageContentNode = mainPageContentNode;
    this.mainPageResultBlockNode = mainPageResultBlockNode;
  }

  _createClass(MainPageClass, [{
    key: "renderMainPageWrapper",
    value: function renderMainPageWrapper() {
      wrapper.insertAdjacentHTML('afterbegin', '<div class="main-page"></div>');
    }
  }, {
    key: "renderMainPageHeader",
    value: function renderMainPageHeader(mainPageWrapper, mainPageHeaderNode) {
      mainPageWrapper.insertAdjacentHTML('beforeend', mainPageHeaderNode);
    }
  }, {
    key: "__renderPuzzles",
    value: function () {
      var _renderPuzzles = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var _this = this;

        var exampleList, textData, state, wordsList;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                exampleList = document.querySelectorAll('.main-page__main-block__string');
                _context.next = 3;
                return Object(_services_get_words_service__WEBPACK_IMPORTED_MODULE_21__["getWords"])();

              case 3:
                textData = _context.sent;
                state = JSON.parse(localStorage.getItem('state'));
                exampleList[state.currentExample - 1].classList.add('current');
                exampleList.forEach(function (el, index) {
                  el.style.gridTemplateColumns = "repeat(".concat(textData[index].example.length, ", 1fr)");
                  textData[index].example.forEach(function (word, indexWordInString) {
                    el.insertAdjacentHTML('beforeend', "<div class=\"main-page__main-block__string__el\" index=\"".concat(indexWordInString, "\"><p>").concat(word, "</p></div>"));
                  });
                });
                wordsList = document.querySelectorAll('.main-page__main-block__string__el');
                ...
                exampleList.forEach(function (string, indexString) {
                  string.querySelectorAll('.main-page__main-block__string__el__puzzle').forEach(function (puzzle, indexPuzzle) {
                    if (string.querySelectorAll('.main-page__main-block__string__el__puzzle').length > 10) {
                      string.querySelectorAll('.main-page__main-block__string__el__puzzle').forEach(function (el) {
                        el.parentNode.style.fontSize = '12px';
                      });
                    }

                    _this.createPuzzle(puzzle, string.querySelectorAll('.main-page__main-block__string__el__puzzle').length, indexPuzzle, indexString);

                    _this.fillPuzzle(puzzle, string.querySelectorAll('.main-page__main-block__string__el__puzzle').length, indexPuzzle, indexString);
                  });
                });
                this.audioHint();
                document.querySelectorAll('.main-page__main-block__string').forEach(function (el, index) {
                  if (index >= state.currentExample - 1) {
                    var randomArray = _toConsumableArray(el.querySelectorAll('.main-page__main-block__string__el')).sort(function () {
                      return Math.random() - 0.5;
                    });

                    el.innerHTML = '';
                    el.append.apply(el, _toConsumableArray(randomArray));
                  }
                });
      ...
      function __renderPuzzles() {
        return _renderPuzzles.apply(this, arguments);
      }

      return __renderPuzzles;
    }()
    ...
    key: "createPuzzle",
    value: function createPuzzle(puzzle, length, index, indexString) {
    ...
    key: "fillPuzzle",
    value: function fillPuzzle(puzzle, length, index, indexString) {
      var ctx = puzzle.getContext('2d');
      ctx.beginPath();
      ctx.moveTo(0, 0);
    ...
    key: "renderMainPageContent",
    value: function () {
      var _renderMainPageContent = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(mainPageContentNode) {
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
      ...
      function renderMainPageContent(_x) {
        return _renderMainPageContent.apply(this, arguments);
      }

      return renderMainPageContent;
    }()
  }, {
    key: "renderMainPageResultBlock",
    value: function renderMainPageResultBlock(mainPageResultBlockNode) {
      var state = JSON.parse(localStorage.getItem('state'));
      document.querySelector('.main-page__main-block').insertAdjacentHTML('afterend', mainPageResultBlockNode);
      var resultBlock = document.querySelector('.main-page__result-block');
      resultBlock.style.gridTemplateColumns = "repeat(".concat(state.words[state.currentExample - 1].example.length, ", 1fr)");

      for (var i = 0; i < state.words[state.currentExample - 1].example.length; i += 1) {
    ...
    key: "renderMainPageButtonsBlock",
    value: function renderMainPageButtonsBlock(mainPageWrapper, mainPageButtonsBlockNode) {
      mainPageWrapper.insertAdjacentHTML('beforeend', mainPageButtonsBlockNode);
    }
  }, {
    key: "dragAndDrop",
    value: function dragAndDrop() {
      var exampleList = document.querySelectorAll('.main-page__main-block__string');
      var state = JSON.parse(localStorage.getItem('state'));
      exampleList[state.currentExample - 1].children.forEach(function (el) {
        el.setAttribute('draggable', 'true');
      });
      var words = document.querySelectorAll('.main-page__main-block__string__el') || document.querySelectorAll('.main-page__main-block__block__el');
      var cells = document.querySelectorAll('.main-page__result-block__el');
      var draggingItem;
      var currentWord;
    ...
    key: "clickOnPuzzle",
    value: function clickOnPuzzle() {
      var exampleList = document.querySelectorAll('.main-page__main-block__string');
      var state = JSON.parse(localStorage.getItem('state'));
      var resultBlock = document.querySelector('.main-page__result-block');

      function appendPuzzle() {
        var cell = resultBlock.querySelector('[isfree="true"]');
        if (cell == null) return;
        cell.append(this);
      ...
      var words = exampleList[state.currentExample - 1].querySelectorAll('.main-page__main-block__string__el');
      words.forEach(function (word) {
    ...
    key: "checkResultBlock",
    value: function checkResultBlock() {
      var state = JSON.parse(localStorage.getItem('state'));
      var resultBlock = document.querySelector('.main-page__result-block');
      var resultNodes = resultBlock.querySelectorAll('.main-page__main-block__string__el');
      var result = [];
      resultNodes.forEach(function (el) {
        result.push(el.textContent);
      });
      var count = 0;
      resultNodes.forEach(function (el, index) {
      ...
      if (count === result.length && count !== 0) {
        var nextExample = function nextExample() {
          var translateBtn = document.querySelector('.main-page__control-block__hints__translate');
          var correctExample = resultBlock.querySelectorAll('.main-page__main-block__string__el');
          var currentString = document.querySelectorAll('.main-page__main-block__string')[state.currentExample - 1];
          var nextString = document.querySelectorAll('.main-page__main-block__string')[state.currentExample];
          correctExample.forEach(function (el) {
          ...
          currentString.append.apply(currentString, _toConsumableArray(correctExample));
          ...
          mainPage.renderMainPageResultBlock(_nodes__WEBPACK_IMPORTED_MODULE_22__["mainPageResultBlockNode"]);
          localStorage.setItem('state', JSON.stringify(state));
    ...
    key: "defineHintsState",
    value: function defineHintsState() {
      var state = JSON.parse(localStorage.getItem('state'));
      var translateBtn = document.querySelector('.main-page__control-block__hints__translate');
      var audioBeginBtn = document.querySelector('.main-page__control-block__hints__audio-begin');
      var audioRepeatBtn = document.querySelector('.main-page__control-block__hints__audio-repeat');
      var backgroundBtn = document.querySelector('.main-page__control-block__hints__background');
      var translateNode = document.querySelector('.main-page__active-hints__translate');
    ...
    key: "showOrHideTranslate",
    value: function showOrHideTranslate(hintsState) {
      var state = JSON.parse(localStorage.getItem('state'));
      var translateNode = document.querySelector('.main-page__active-hints__translate');
    ...
    key: "audioHint",
    value: function audioHint() {
      var state = JSON.parse(localStorage.getItem('state'));
      var audio = new Audio();
      audio.preload = 'auto';
      audio.src = "https://raw.githubusercontent.com/yarkin13/rslang-data/master/".concat(state.words[state.currentExample - 1].audioSrc);
      audio.play();
    }
  }, {
    key: "correctSequence",
    value: function correctSequence() {
      var state = JSON.parse(localStorage.getItem('state'));
      var resultBlock = document.querySelector('.main-page__result-block');
      var inCorrectSequence = document.querySelector('.main-page__result-block').querySelectorAll('.main-page__main-block__string__el');

      var correctSequence = _toConsumableArray(inCorrectSequence).sort(function (a, b) {
        return a.getAttribute('index') - b.getAttribute('index');
      });

      resultBlock.append.apply(resultBlock, _toConsumableArray(correctSequence));
    }
  }]);
...
function errorHandlerRegistrationExistEmail() {
  var noticeDescriptions = document.querySelector('.notice-block__description');
...
function errorHandlerRegistrationInvalid(errors) {
  var noticeDescriptions = document.querySelectorAll('.notice-block__description');
  var noticeBlock = document.querySelector('.notice-block');
  noticeDescriptions.forEach(function (el, index) {
  ...
  function hideNoticeBlock() {
    noticeBlock.style = 'display: none';
    noticeDescriptions.forEach(function (el) {
...
function errorHandlerLogInIncorrectEmailOfPassword() {
  var noticeDescriptions = document.querySelector('.notice-block__description');
  var noticeBlock = document.querySelector('.notice-block');
...
/***/ "./src/js/services/get-words.service.js":
/*!**********************************************!*\
  !*** ./src/js/services/get-words.service.js ***!
  \**********************************************/
/*! exports provided: getWords */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            group = _args.length > 1 && _args[1] !== undefined ? _args[1] : 0;
            state = JSON.parse(localStorage.getItem('state'));
            url = "https://afternoon-falls-25894.herokuapp.com/words?page=".concat(page, "&group=").concat(group);
            _context.next = 6;
            return fetch(url);
          ...
          case 12:
            arrayWords = _context.sent;
            exampleFiltered = arrayWords.map(function (element) {
              return element.example.map(function (el) {
                return el.replace(/<b>/gm, '').replace(/<\/b>/gm, '');
              });
            });
            arrayWords.forEach(function (el, index) {
              el.example = exampleFiltered[index];
            });
            state.words = arrayWords;
            localStorage.setItem('state', JSON.stringify(state));
            return _context.abrupt("return", arrayWords);
