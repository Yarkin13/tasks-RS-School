...
var mainPage = new _main_page_class__WEBPACK_IMPORTED_MODULE_6__["default"](_nodes__WEBPACK_IMPORTED_MODULE_4__["mainPageContentNode"], _nodes__WEBPACK_IMPORTED_MODULE_4__["mainPageResultBlockNode"]);
mainPage.renderMainPageWrapper();
var mainPageWrapper = document.querySelector('.main-page');
mainPage.renderMainPageHeader(mainPageWrapper, _nodes__WEBPACK_IMPORTED_MODULE_4__["mainPageHeaderNode"]);
mainPage.renderMainPageContent(_nodes__WEBPACK_IMPORTED_MODULE_4__["mainPageContentNode"]);
...
var checkBtn = document.querySelector('.main-page__buttons__check');
var clearBtn = document.querySelector('.main-page__buttons__clear');
...
/* harmony import */ var _services_get_words_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./services/get-words.service */ "./src/js/services/get-words.service.js");
  ...
  _createClass(MainPageClass, [{
    ...
    value: function () {
      var _renderPuzzles = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        ...
        var textList, textData, state;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                textList = document.querySelectorAll('.main-page__main-block__string');
                _context.next = 3;
                return Object(_services_get_words_service__WEBPACK_IMPORTED_MODULE_7__["getWords"])();
              ...
              case 3:
                ...
                textList.forEach(function (el, index) {
                  ...
                  textData[index].example.forEach(function (word) {
                    el.insertAdjacentHTML('beforeend', "<div class=\"main-page__main-block__string__el\"><p>".concat(word, "</p></div>"));
                  });
                });
                document.querySelectorAll('.main-page__main-block__string__el').forEach(function (el, index) {
                  el.insertAdjacentHTML('beforeend', "<canvas class=\"main-page__main-block__string__el__puzzle\"></canvas>");
                });
                document.querySelectorAll('.main-page__main-block__string').forEach(function (string, indexString) {
                  string.querySelectorAll('.main-page__main-block__string__el__puzzle').forEach(function (puzzle, indexPuzzle) {
                    ...
                    _this.drawPuzzle(puzzle, string.querySelectorAll('.main-page__main-block__string__el__puzzle').length, indexPuzzle, indexString);
                  });
                });
                document.querySelectorAll('.main-page__main-block__string').forEach(function (el) {
                  el.querySelectorAll('.main-page__main-block__string__el').forEach(function (puzzle, index) {});
                });
    ...
    key: "drawPuzzle",
    value: function drawPuzzle(puzzle, length, index, indexString) {
    ...
    value: function dragAndDrop() {
      var state = JSON.parse(localStorage.getItem('state'));
      document.querySelectorAll('.main-page__main-block__string')[state.currentExample - 1].children.forEach(function (el) {
        el.setAttribute('draggable', 'true');
      });
      var words = document.querySelectorAll('.main-page__main-block__string__el');
      var cells = document.querySelectorAll('.main-page__result-block');
      var currentWord;
    ...
    value: function click() {
      var state = JSON.parse(localStorage.getItem('state'));
      var cell = document.querySelector('.main-page__result-block');
      console.log(cell);
      ...
      var words = document.querySelectorAll('.main-page__main-block__string')[state.currentExample - 1].querySelectorAll('.main-page__main-block__string__el');
      words.forEach(function (word) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 9:
            ...
            return data.map(function (el) {
              return {
                ...
                randomSequenceExample: el.textExample.split(' ').sort(function () {
          ...
          case 12:
            ...
            exampleFiltered = arrayWords.map(function (element, index) {
              return element.example.map(function (el) {
                return el.replace(/<b>/gm, '').replace(/<\/b>/gm, '');
              });
            });
            randomSequenceExampleFiltered = arrayWords.map(function (element, index) {
              return element.randomSequenceExample.map(function (el) {
                return el.replace(/<b>/gm, '').replace(/<\/b>/gm, '');
              });
            });
