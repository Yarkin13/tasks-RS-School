import {errorHandlerRegistrationExistEmail, errorHandlerRegistrationInvalid,
  errorHandlerLogInIncorrectEmailOfPassword } from './services/error-handler'
  ...
  async registration(registrationData) {
    try {
     ...
     if(content.hasOwnProperty('error')) {
       const errors = content.error.errors.map((el) => {
        return el.message;
       })
