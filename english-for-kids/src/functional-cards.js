...
CARDS_CONTAINER.addEventListener('click', (event) => { // add audio
  ...
  const indexForAnalytics = arrayAnalytics.find((el) => el.word === stateNow.currentCard);
...
CARDS_CONTAINER.addEventListener('click', (event) => { // flip
